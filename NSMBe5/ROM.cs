...
namespace NSMBe5 {
	public static class ROM {
		...
		public static int[] FileSizes = {
											...
											0x400, //Jyotyu_CHK
											ROM.NativeStageObjCount*2, //Modifiers
										};
...
//                                            80, 81, 82, 83, 86, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111};
		...
		public static int[,] GetObjectBankOverlays()
		{
			byte[] data = new byte[0x280];
			Array.Copy(ROM.DecompressOverlay(ROM.arm9binFile.getContents()), 0x263B4, data, 0, 0x280);

			int[,] overlays = new int[16, 10];
			Buffer.BlockCopy(data, 0, overlays, 0, 0x280);
