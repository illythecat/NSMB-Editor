...
namespace NSMBe5
{
	public class NSMBExtraData
	{
		...
		public void setStageObjSettings(byte[] settings) {
			this.data[14] = settings[0];
			this.data[15] = settings[1];
			this.data[7] = settings[2];
			this.data[6] = settings[3];
			this.data[5] = settings[4];
			this.data[4] = settings[5];
		}
		...
		public byte[] getStageObjSettings() {
			return new byte[6]
			{
		this.data[14],
		this.data[15],
